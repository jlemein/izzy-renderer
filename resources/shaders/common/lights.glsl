...
vec3 GetDirectionalLightContribution_shininess(DirectionalLight light, vec3 n, vec3 v, vec3 albedo, float specularity, float shininess) {
...
vec3 GetDirectionalLightContribution(DirectionalLight light, vec3 n, vec3 v, vec3 albedo, float specularity) {
    return GetDirectionalLightContribution_shininess(light, n, v, albedo, specularity, SHININESS);
}


vec3 GetPointLightContribution_shininess(PointLight light, vec3 p, vec3 n, vec3 v, vec3 albedo, float specularity, float shininess) {
...
vec3 GetPointLightContribution(PointLight light, vec3 p, vec3 n, vec3 v, vec3 albedo, float specularity) {
    return GetPointLightContribution_shininess(light, p, n, v, albedo, specularity, SHININESS);
}

vec3 GetSpotLightContribution_shininess(SpotLight light, vec3 p, vec3 n, vec3 v, vec3 albedo, float specularity, float shininess) {
...
vec3 GetSpotLightContribution(SpotLight light, vec3 p, vec3 n, vec3 v, vec3 albedo, float specularity) {
    return GetSpotLightContribution_shininess(light, p, n, v, albedo, specularity, SHININESS);
}