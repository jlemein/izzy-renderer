...
class DepthPeeling {
 public:
   ...
   * @param gpu             Access to GPU data structures.
   * @param registry        Scene graph for entity retrieval.
   ...
   */
  DepthPeeling(std::shared_ptr<Gpu> gpu, const entt::registry& registry, int numPeelPasses = 3);
