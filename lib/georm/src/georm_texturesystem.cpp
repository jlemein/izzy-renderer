...
void TextureSystem::setTextureLoader(const std::string &extension, std::unique_ptr<geo::ITextureLoader> textureLoader) {
    if (extension.empty()) {
...
void TextureSystem::setTextureLoader(const std::vector<std::string> &extensions,
                                     std::unique_ptr<geo::ITextureLoader> textureLoader) {
