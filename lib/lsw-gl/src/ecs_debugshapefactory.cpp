...
DebugModel DebugShapeFactory::MakeEulerArrow(entt::registry& registry, entt::entity target) {
  ...
  shader = izz::gl::Material{.vertexShader = "assets/shaders/diffuse-color.vert.spv", .fragmentShader = "assets/shaders/diffuse-color.frag.spv"};
...
DebugModel DebugShapeFactory::MakeCameraBox(entt::registry& registry, entt::entity target) {
  ...
  cameraBox.material.push_back(
      izz::gl::Material{.isBinaryShader = true, .vertexShader = "assets/shaders/debug.vert.spv", .fragmentShader = "assets/shaders/debug.frag.spv"});
  ...
  auto shader = izz::gl::Material{.vertexShader = "assets/shaders/debug.vert.spv", .fragmentShader = "assets/shaders/debug.frag.spv"};
